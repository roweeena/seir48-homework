...
# letters have lots of straight lines and are hence easy to hack into stone tablets using a chisel).
#
# ```plain
#  1  => I
# 10  => X
...
# Wikipedia says: "Modern Roman numerals ... are written by expressing each
 # digit separately starting with the left most digit and skipping any digit with a value of zero."
#
