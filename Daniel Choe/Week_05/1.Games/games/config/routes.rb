Rails.application.routes.draw do
  ...
  get '/eight-ball' => 'eightball#eightballhome'
  get '/eight-ball/answer' => 'eightball#answer'

  get '/secret-number' => 'secretnumber#secretnumberhome'
  get '/secret-number/result/:num' => 'secretnumber#resultcheck'
