...
class Robot
  ...
  attr_reader :name, :reset_at, :created_at
  ...
  def timers
    ...
    " #{ time_since_last_reset.round(2) } seconds since last boot, #{ time_since_creation.round(2) } seconds since creation."
  end
