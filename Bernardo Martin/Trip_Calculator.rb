...
puts "Trip Calculator".center(80)
puts "<>"*40
  ...
  print "Speed in miles: "
  speed = gets.to_f
  miles_with_speed = 0
def trip_calculator
  if speed > 60
        miles_with_speed = 0.7
      elsif speed < 60
        miles_with_speed = 0.9
      else
        miles_with_speed = 1
      end

  trip_total = (dist / (miles_per_gallon * miles_with_speed)) * price_per_gallon
  puts "Your total cost for this trip is #{trip_total} AUS."
end
